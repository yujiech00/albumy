                ...
                value: function () {
                    (this.prototype.Emitter = Emitter),
                        ...
                        (this.prototype.defaultOptions = {
                            ...
                            filesizeBase: 1e3,
                            maxFiles: 1, //change from null to 1
                            headers: null,
                            clickable: !0,
                            ignoreHiddenFiles: !0,
                            acceptedFiles: null,
                            ...
                            autoProcessQueue: !0,
                            autoQueue: !0, 
                            addRemoveLinks: !1, //change from !1 to 1: Allow users to remove/cancel files before uploading them
                            ...
                            uploadprogress: function (a, b, c) {
                                if (a.previewElement)
                                    for (var d = a.previewElement.querySelectorAll("[data-dz-uploadprogress]"), e = 0, d = d; ; ) {
                                        ...
                                        var progressElementContainer = a.previewElement.querySelector(".dz-progress"); //added
                                        var progressElement = a.previewElement.querySelector("[data-dz-uploadprogress]"); //added
                                        progressElementContainer.style.height="25px"; //addded
                                        progressElement.style.width = b + "%"; //addded
                                        progressElement.style.background="#009E60";
                                        progressElement.style.color="white"; //addded
                                        progressElement.style.textAlign="center"; //added
                                        progressElement.textContent = b + "%";  //addded
                                    }
                            },
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        this.on("addedfile", function (file) {
                            ...
                            var maxFiles = a.options.maxFiles;
                            for (var i = this.files.length - maxFiles -1; i >= 0; i--) {
                                var f = this.files[i];
                                if (f.upload.uuid !== file.upload.uuid)
                                    this.removeFile(f);
                            }
                        }); // limit the number of files that can be uploaded each time to be 1
